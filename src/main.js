...
import { faCircle, faPause, faDownload, faEye, faTrash, faCaretUp, faCaretDown, faRefresh } from '@fortawesome/free-solid-svg-icons'
...
library.add(faCircle, faPause, faDownload, faEye, faTrash, faCaretUp, faCaretDown, faRefresh);
